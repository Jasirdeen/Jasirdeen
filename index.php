...
<body>
	<div class = "navbar navbar-default navtop">
		<img src = "images/logo.png" style = "float:left;" height = "55px" /><label class = "navbar-brand">PatientRecord Management System</label>
	</div>
		<div id = "sidelogin">
		...
		<img src = "images/Caresync logo.png" class = "background">			
	<div id = "footer">
